...
function renderStandings(teams) {
  return `<article class="rh-panel rh-standings" aria-labelledby="rh-standings-title">
    <div class="rh-panel-heading"><div><h2 id="rh-standings-title">CPL 2026 Points Table</h2><p class="rh-section-copy">CPL standings track wins, losses, points, and net run rate for playoff qualification.</p></div><a href="/points-table/">View full table <i data-lucide="arrow-right" aria-hidden="true"></i></a></div>
...
function renderFeatureTiles() {
  ...
  return `<section class="rh-section rh-feature-tiles" aria-labelledby="rh-explore-title"><div class="rh-section-title"><div><p class="rh-eyebrow">Tournament navigation</p><h2 id="rh-explore-title">Explore CPL 2026</h2><p class="rh-section-copy">Direct access to official tournament guides with fast links.</p></div></div><nav class="rh-feature-grid" aria-label="Explore CPL 2026">${tiles.map(([icon, title, text, href]) => `<a href="${href}" class="rh-feature-tile"><i data-lucide="${icon}" aria-hidden="true"></i><strong>${title}</strong><span>${text}</span><b><i data-lucide="arrow-right" aria-hidden="true"></i></b></a>`).join("")}</nav></section>`;
}
...
function renderReferenceHome(data) {
  ...
  return `<main class="home-page rh-home" id="main-content">
    <section class="rh-hero" aria-labelledby="rh-hero-title">
      ...
      <div class="rh-hero-content"><p class="rh-eyebrow">CPL 2026 Caribbean Premier League</p><h1 id="rh-hero-title"><span>Caribbean Cricket's</span> <strong>Biggest Party</strong> <span>Returns</span></h1><p>Caribbean Premier League 2026 brings 39 T20 matches across eight venues. Live scores, fixtures, squads, standings, and broadcast channels update daily.</p><div class="rh-hero-actions"><a class="rh-button rh-button-yellow" href="/fixtures/">View Schedule <i data-lucide="arrow-right" aria-hidden="true"></i></a><a class="rh-button rh-button-outline" href="/teams/">Explore Teams <i data-lucide="arrow-right" aria-hidden="true"></i></a></div></div>
